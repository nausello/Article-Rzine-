...
La première, celle de la régionalisation contrainte, part des observations individuelles géolocalisées et reconstruit une partition de l'espace *ex nihilo* en optimisant une fonction de cohésion sous contrainte de contiguïté spatiale : c'est la démarche de la classification hiérarchique géographiquement contrainte [@Chavent2018], de l'algorithme SKATER [@Assuncao2006] ou des approches REDCAP [@Guo2008]. La seconde logique, moins outillée, ne cherche pas à créer un découpage mais à évaluer la pertinence d'un d'un découpage existant [@Coombes1986; @Farmer2011; @Klapka2013] : dans quelle mesure un découpage institutionnel (EPCI, arrondissement, zone d'emploi) reflète-t-il une réalité socio-spatiale homogène, ou agrège-t-il au contraire des unités dont les profils seraient statistiquement plus proches d'un groupement voisin [@Openshaw1984; @Briant2015] ? 
